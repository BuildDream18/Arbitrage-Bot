...
export const createPortfolioRequest = async (user: string, name: string): Promise<Portfolio> => {
    ...
    const portfolioWithWallet: PortfolioWithWallet = (({ user, id, name, wallet }) => ({ user, id, name, wallet }))(data)
    return portfolioWithWallet
}
...
export const getWalletsRequest = async (user: string): Promise<Wallet[]> => {
    const request: ListPortfoliosRequest = { user }
    const data = postApi<Wallet[], ListPortfoliosRequest>("/ListWallets", request)
    return data
}
...
export const getPortfolioAssets = async (portfolio: string): Promise<ListPortfolioAssetsResponse> => {
    ...
    return postApi<ListPortfolioAssetsResponse, ListPortfolioAssetsRequest>("/ListPortfolioAssets", request)
}
