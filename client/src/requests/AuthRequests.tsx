...
export const signupRequest = async (name: string, email: string, password: string): Promise<UserToken> => {
    const createUserRequest: CreateUserRequest = {name, email, password}
